...
export default class Authentication {
  ...
  acquireUserTokenSilent=(user)=>{
   const auth_token= this.app.acquireTokenSilent(this.applicationConfig.graphScopes, 'https://login.microsoftonline.com/tfp/{domain name}/{policy}', user).then((token)=>{
